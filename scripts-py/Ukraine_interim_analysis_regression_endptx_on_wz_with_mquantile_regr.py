...
interpolate the conditional CDF at ``pps_H1_min_effect_size_thresh`` to produce a continuous
``p_h1_xz = 1 - F_hat(pps_H1_min_effect_size_thresh | w) in [0, 1]`` (Rao-Blackwellised). The PPS is the Monte-Carlo average
