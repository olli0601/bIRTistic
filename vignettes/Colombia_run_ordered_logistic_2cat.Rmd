...
if (grepl("^/rds/general/user/or105", here::here())) {
    ...
    dir_out <- "/rds/general/user/or105/home/WORK/2025_project_Hope_Groups/colombia-run-orderedlogistic-251216"
} else {
    # Working locally
    on_hpc <- FALSE
    dir_data <- "/Users/or105/Library/CloudStorage/OneDrive-ImperialCollegeLondon/OR_Work/2025/2025_project_Hope_Groups/data"
    dir_out <- "/Users/or105/sandbox/colombia-run-orderedlogistic-251216"
}
...
debug(ordered_logit_model_run_analysis)
...
undebug(ordered_logit_model_run_analysis)
```
