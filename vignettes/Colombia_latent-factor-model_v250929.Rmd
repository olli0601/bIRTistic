...
dir_out <- file.path(dir_home, "colombia-250929")
...
file_prefix <- "colombia_outcomes_"
...
knitr::include_graphics(file.path(dir_out, paste0(file_prefix, "response_frequencies.png")))
```
...
# save output to RDS
ordcat_logit_fit_m5b$save_object(file = file.path(dir_out, paste0(file_prefix, "stan.rds")))
```

```{r ordered_logistic_latent_factor-b_load_model, include=FALSE, eval=TRUE, echo=FALSE, tidy=FALSE, cache=TRUE}
ordcat_logit_fit_m5b <- readRDS(file = file.path(dir_out, paste0(file_prefix, "stan.rds")))
```
...
p <- p + theme_bw()
ggsave(
  file = file.path(dir_out, paste0(file_prefix, "worsttrace.png")),
  plot = p,
  h = 10,
  w = 8
)
...
p <- bayesplot::mcmc_intervals(po, prob = 0.5, prob_outer = 0.95, outer_size = 1, point_size = 2) +
  theme_bw()
ggsave(
  file = file.path(dir_out, paste0(file_prefix, "intervals.png")),
  plot = p,
  h = 50,
  w = 8,
  limitsize = FALSE
...
ggsave(
  file = file.path(dir_out, paste0(file_prefix, "pairsplot.png")),
  plot = p,
  h = 30,
  w = 30,
  limitsize = FALSE
...
ggsave(
  file = file.path(dir_out, paste0(file_prefix, "ppcheck.png")),
  p,
  w = 12,
  h = 12
)
...
ggsave(
  file = file.path(dir_out, paste0(file_prefix, "participant_effects.png")),
  plot = p,
  h = 8,
  w = 12
)
...
knitr::include_graphics(file.path(dir_out, paste0(file_prefix, "participant_effects.png")))
```
...
p <- p + scale_fill_npg() +
  theme_bw()
ggsave(
  file = file.path(dir_out, paste0(file_prefix, "eta_pairsplot.png")),
  plot = p,
  h = 10,
  w = 10
)
...
knitr::include_graphics(file.path(dir_out, paste0(file_prefix, "eta_pairsplot.png")))
```
...
ggsave(
  file = file.path(dir_out, paste0(file_prefix, "probs_barplot.png")),
  plot = p,
  h = 8,
  w = 8
)
...
knitr::include_graphics(file.path(dir_out, paste0(file_prefix, "probs_barplot.png")))
```
...
ggsave(
  file = file.path(dir_out, paste0(file_prefix, "probs_barplot_v2.png")),
  plot = p,
  h = 10,
  w = 8
)
...
knitr::include_graphics(file.path(dir_out, paste0(file_prefix, "probs_barplot_v2.png")))
```
...
file_prefix <- "cgmh_vio_monitor_mlf_1_"
...
tmp <- tmp[, list(item_label = item_label, item_id = seq_along(item_label)), by = "item_type"]
dcat2 <- merge(dcat2, tmp, by = "item_label")
setkey(dcat2, pid, time, item_label)
dcat2[, oid := seq_len(nrow(dcat2))]
tmp <- dcat2[, list(oid = oid, oidt = seq_along(y_stan)), by = "item_type"]
...
# save output to RDS
mixed_lfm_logit_m1_fit$save_object(file = file.path(dir_out, paste0(file_prefix, "stan.rds")))
```
...
mixed_lfm_logit_m1_fit <- readRDS(file = file.path(dir_out, paste0(file_prefix, "stan.rds")))
```
...
tmp <- mixed_lfm_logit_m1_fit$summary(
  variables = c(
    "latent_factor_group", "latent_factor_unit", "latent_factor_unit_sd",
...
po <- po[,
  list(
    prob = dbinom(0:stan_data$NbinMax, stan_data$NbinMax, mean(prob)),
...
tmp <- dcat3[, list(oid = oid, oidt = seq_along(y_stan)), by = "item_type"]
...
# save output to RDS
binomial_lfm_m3_fit$save_object(file = file.path(dir_out, paste0(file_prefix, "stan.rds")))
```


```{r mlf3_load_model, include=FALSE, eval=TRUE, echo=FALSE, tidy=FALSE, cache=TRUE}
binomial_lfm_m3_fit <- readRDS(file = file.path(dir_out, paste0(file_prefix, "stan.rds")))
```
...
tmp <- binomial_lfm_m3_fit$summary(
  variables = c(
    "latent_factor_group", "latent_factor_unit",
...
file_prefix <- "cgmh_vio_monitor_mlf_4_"
...
tmp <- dcat4[, list(oid = oid, oidt = seq_along(y_stan)), by = "item_type"]
...
# save output to RDS
ocat_lfm_m4_fit$save_object(file = file.path(dir_out, paste0(file_prefix, "stan.rds")))
```


```{r mlf4_load_model, include=FALSE, eval=TRUE, echo=FALSE, tidy=FALSE, cache=TRUE}
ocat_lfm_m4_fit <- readRDS(file = file.path(dir_out, paste0(file_prefix, "stan.rds")))
```
...
dcat5[, oid := seq_len(nrow(dcat5))]
tmp <- dcat5[, list(oid = oid, oidt = seq_along(y_stan)), by = "item_type"]
...
# save output to RDS
ocat_lfm_m4all_fit$save_object(file = file.path(dir_out, paste0(file_prefix, "stan.rds")))
```


```{r mlf4all_load_model, include=FALSE, eval=TRUE, echo=FALSE, tidy=FALSE, cache=TRUE}
ocat_lfm_m4all_fit <- readRDS(file = file.path(dir_out, paste0(file_prefix, "stan.rds")))
```
...
p <- bayesplot::mcmc_areas(po, prob = 0.5, prob_outer = 0.95, point_est = "median") +
  theme_bw()
ggsave(
  file = file.path(dir_out, paste0(file_prefix, "areas.png")),
  plot = p,
  h = 150,
  w = 8,
  limitsize = FALSE
...
# save output to RDS
ocat_lfm_m5all_fit$save_object(file = file.path(dir_out, paste0(file_prefix, "stan.rds")))
```


```{r mlf5all_load_model, include=FALSE, eval=TRUE, echo=FALSE, tidy=FALSE, cache=TRUE}
ocat_lfm_m5all_fit <- readRDS(file = file.path(dir_out, paste0(file_prefix, "stan.rds")))
```
...
tmp <- ocat_lfm_m5all_fit$summary(
  variables = c(
    "latent_factor_unit", "latent_factor_unit_sd",
    "beta_cat_questions", "loadings_cat_questions_m1", "cat_cut_point_1", "cat_cut_point_gaps_groups",
    "beta_cat2_questions", "loadings_cat2_questions_m1", "cat2_cut_point_1", "cat2_cut_point_gaps_groups"
  ),
  posterior::default_summary_measures(),
...
# save output to RDS
ocat_lfm_m6all_fit$save_object(file = file.path(dir_out, paste0(file_prefix, "stan.rds")))
```


```{r mlf6all_load_model, include=FALSE, eval=TRUE, echo=FALSE, tidy=FALSE, cache=TRUE}
ocat_lfm_m6all_fit <- readRDS(file = file.path(dir_out, paste0(file_prefix, "stan.rds")))
```
...
file_prefix <- "cg_chi_all_upgcm1_"
dcat5 <- copy(dp1)
dcat5[, time := time + 1L]
dcat5[, y_stan := y + 1L]
tmp <- data.table(item_label = sort(unique(dcat5$item_label)))
...
# save output to RDS
upgcm_m1_all_fit$save_object(file = file.path(dir_out, paste0(file_prefix, "stan.rds")))
```

```{r upgcm1all_load_model, include=FALSE, eval=TRUE, echo=FALSE, tidy=FALSE, cache=TRUE}
upgcm_m1_all_fit <- readRDS(file = file.path(dir_out, paste0(file_prefix, "stan.rds")))
```
...
file_prefix <- "cg_chi_all2_upgcm1_"
dcat6 <- copy(dp1)
dcat6[, time := time + 1L]
dcat6[, y_stan := y + 1L]
tmp <- CJ(
...
tmp[, item_type := ifelse(grepl("CG-MH", item_label), "categorical", "out-of-7")]
tmp <- tmp[, list(item_label = item_label, time = time, item_time_id = seq_along(item_label)), by = "item_type"]
...
# save output to RDS
upgcm_m1_all2_fit$save_object(file = file.path(dir_out, paste0(file_prefix, "stan.rds")))
```

```{r upgcm1all2_load_model, include=FALSE, eval=TRUE, echo=FALSE, tidy=FALSE, cache=TRUE}
upgcm_m1_all2_fit <- readRDS(file = file.path(dir_out, paste0(file_prefix, "stan.rds")))
```
...
file_prefix <- "cg_chi_all_upgcm2_"
dcat5 <- copy(dp1)
dcat5[, time := time + 1L]
dcat5[, y_stan := y + 1L]
tmp <- data.table(item_label = sort(unique(dcat5$item_label)))
...
# save output to RDS
upgcm_m2_all_fit$save_object(file = file.path(dir_out, paste0(file_prefix, "stan.rds")))
```

```{r upgcm2all_load_model, include=FALSE, eval=TRUE, echo=FALSE, tidy=FALSE, cache=TRUE}
upgcm_m2_all_fit <- readRDS(file = file.path(dir_out, paste0(file_prefix, "stan.rds")))
```
...
tmp <- upgcm_m2_all_fit$summary(
  variables = c(
    "latent_factor_unit", "latent_factor_unit_endline",
    "cat1_skill_thresholds_1", "cat1_skill_thresholds_incs", "cat1_loadings_questions",
    "cat2_skill_thresholds_1", "cat2_skill_thresholds_incs", "cat2_loadings_questions"
  ),
  posterior::default_summary_measures(),
...
ocat_lfm_m6all_fit <- readRDS(file = file.path(dir_out, "cg_chi_all_lf6_stan.rds"))
upgcm_m1_all_fit <- readRDS(file = file.path(dir_out, "cg_chi_all_upgcm1_stan.rds"))
upgcm_m1_all2_fit <- readRDS(file = file.path(dir_out, "cg_chi_all2_upgcm1_stan.rds"))
upgcm_m2_all_fit <- readRDS(file = file.path(dir_out, "cg_chi_all_upgcm2_stan.rds"))
