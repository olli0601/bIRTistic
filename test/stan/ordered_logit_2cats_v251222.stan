...
transformed data {
  ...
  // Create upper triangular-like matrix for cumulative sums
  for (i in 1 : Kcat1) {
    for (j in 1 : (Kcat1 - 1)) {
...
generated quantities {
  ...
  cat1_ordinal_brier_score = ol_get_ordered_brier_score(
  ...
  cat2_ordinal_brier_score = ol_get_ordered_brier_score(
