...
dir_out <- file.path(dir_home, "analysis-250814")
file_data <- file.path(dir_data, "PHQ_VAC_Jordan_v250812.csv")
set.seed(42L)
```
...
setnames(
  dp,
  c(
    "PHQ4_down_num", "PHQ4_interest_num", "PHQ4_nervous_num", "PHQ4_worry_num",
  ...
  c(
    "PHQ4_down", "PHQ4_interest", "PHQ4_nervous", "PHQ4_worry",
...
file_prefix <- "parentalmh_ordcat_"
...
ggsave(
  file = file.path(dir_out, paste0(file_prefix, "frequencies.png")),
  plot = p,
  h = 10,
  w = 8
)
...
knitr::include_graphics(file.path(dir_out, paste0(file_prefix, "frequencies.png")))
```
...
p <- ggplot(tmp, aes(x = value, fill = PHQ4_down, group = PHQ4_down)) +
  ...
  facet_grid(arm_label ~ time_label)
ggsave(
  file = file.path(dir_out, paste0(file_prefix, "counts_correlations_across_PHQ_questions_same_arm-time.png")),
  plot = p,
  h = 8,
  w = 8
)
...
ggsave(
  file = file.path(dir_out, paste0(file_prefix, "counts_correlations_across_time_same_arm-question.png")),
  plot = p,
  h = 8,
  w = 8
)
...
knitr::include_graphics(file.path(dir_out, paste0(file_prefix, "counts_correlations_across_time_same_arm-question.png")))
```
...
# compile the model
ordcat_logit_filename_m0a <- cmdstanr::write_stan_file(
  gsub("\t", " ", ordcat_logit_txt_m0a),
  dir = dir_out,
  basename = NULL,
...
# compile Stan model
ordcat_logit_compiled_m0a <- cmdstanr::cmdstan_model(ordcat_logit_filename_m0a, force_recompile = TRUE)
```
...
# sample
ordcat_logit_fit_m0a <- ordcat_logit_compiled_m0a$sample(
  data = stan_data,
  seed = 123,
  chains = 2,
  parallel_chains = 2,
...
# save output to RDS
ordcat_logit_fit_m0a$save_object(file = file.path(dir_out, paste0(file_prefix, "m0a_stan.rds")))
```
```{r ordered_logistic_no_unit_effects_v0_load_model, include=FALSE, eval=TRUE, echo=FALSE, tidy=FALSE, cache=TRUE}
ordcat_logit_fit_m0a <- readRDS(file = file.path(dir_out, paste0(file_prefix, "m0a_stan.rds")))
```
...
tmp <- ordcat_logit_fit_m0a$summary(
...
p <- p + theme_bw()
ggsave(
  file = file.path(dir_out, paste0(file_prefix, "m0a_worsttrace.png")),
  plot = p,
  h = 10,
  w = 8
)
...
p <- bayesplot::mcmc_intervals(po, prob = 0.5, prob_outer = 0.95, outer_size = 1, point_size = 2) +
  theme_bw()
ggsave(
  file = file.path(dir_out, paste0(file_prefix, "m0a_intervals.png")),
  plot = p,
  h = 7,
  w = 8,
  limitsize = FALSE
...
ggsave(
  file = file.path(dir_out, paste0(file_prefix, "m0a_pairsplot.png")),
  plot = p,
  h = 50,
  w = 50,
  limitsize = FALSE
...
ggsave(
  file = file.path(dir_out, paste0(file_prefix, "m0a_ppcheck.png")),
  p,
  w = 12,
  h = 12
)
...
ggsave(
  file = file.path(dir_out, paste0(file_prefix, "m0a_probs_barplot.png")),
  plot = p,
  h = 8,
  w = 8
)
...
knitr::include_graphics(file.path(dir_out, paste0(file_prefix, "m0a_probs_barplot.png")))
```
...
ggsave(
  file = file.path(dir_out, paste0(file_prefix, "m0a_frequencies_v2.png")),
  plot = p,
  h = 10,
  w = 8
)
...
# compile the model
ordcat_logit_filename_m0 <- cmdstanr::write_stan_file(
  gsub("\t", " ", ordcat_logit_txt_m0),
  dir = dir_out,
  basename = NULL,
  force_overwrite = FALSE,
  hash_salt = ""
...
# compile Stan model
ordcat_logit_compiled_m0 <- cmdstanr::cmdstan_model(ordcat_logit_filename_m0, force_recompile = TRUE)
```
...
# sample
ordcat_logit_fit_m0 <- ordcat_logit_compiled_m0$sample(
  data = stan_data,
  seed = 123,
  chains = 2,
  parallel_chains = 2,
...
p <- p + theme_bw()
ggsave(
  file = file.path(dir_out, paste0(file_prefix, "m0_worsttrace.png")),
  plot = p,
  h = 10,
  w = 8
)
...
p <- bayesplot::mcmc_intervals(po, prob = 0.5, prob_outer = 0.95, outer_size = 1, point_size = 2) +
  theme_bw()
ggsave(
  file = file.path(dir_out, paste0(file_prefix, "m0_intervals.png")),
  plot = p,
  h = 7,
  w = 8,
  limitsize = FALSE
...
ggsave(
  file = file.path(dir_out, paste0(file_prefix, "m0_pairsplot.png")),
  plot = p,
  h = 50,
  w = 50,
  limitsize = FALSE
...
p <- ggplot(pos, aes(x = oid, group = oid)) +
  ...
  theme(axis.text.x = element_text(angle = 45, vjust = 1, hjust = 1))
ggsave(
  file = file.path(dir_out, paste0(file_prefix, "m0_ppcheck.png")),
  p,
  w = 12,
  h = 12
)
...
ggsave(
  file = file.path(dir_out, paste0(file_prefix, "m0_probs_barplot.png")),
  plot = p,
  h = 8,
  w = 8
)
...
knitr::include_graphics(file.path(dir_out, paste0(file_prefix, "m0_probs_barplot.png")))
```
...
p <- ggplot(tmp, aes(x = value_label)) +
  ...
  labs(x = "", x = "Likert scale", y = "proportion of outcomes", fill = "")
ggsave(
  file = file.path(dir_out, paste0(file_prefix, "m0_frequencies_v2.png")),
  plot = p,
  h = 10,
  w = 8
)
...
knitr::include_graphics(file.path(dir_out, paste0(file_prefix, "m0_frequencies_v2.png")))
```
...
tmp2 <- CJ(
  time_label = unique(tmp$time_label),
...
p <- ggplot(pos, aes(x = PHQ4_down, group = interaction(PHQ4_down, value_label))) +
  ...
  facet_grid(arm_label ~ time_label)
ggsave(
  file = file.path(dir_out, paste0(file_prefix, "m0_polychoric_correlations_across_PHQ_questions_same_arm-time.png")),
  plot = p,
  h = 8,
  w = 8
)
...
knitr::include_graphics(file.path(dir_out, paste0(file_prefix, "m0_polychoric_correlations_across_PHQ_questions_same_arm-time.png")))
```
...
# compile Stan model
ordcat_logit_compiled_m1 <- cmdstanr::cmdstan_model(ordcat_logit_m1_filename)
```
...
file_prefix <- "parentalmh_ordcat_endlineonly_priorsv2_"
...
# compile the model
ordcat_logit_filename_m3 <- cmdstanr::write_stan_file(
  gsub("\t", " ", ordcat_logit_txt_m3),
  dir = dir_out,
  basename = NULL,
  force_overwrite = FALSE,
  hash_salt = ""
...
# compile Stan model
ordcat_logit_compiled_m3 <- cmdstanr::cmdstan_model(ordcat_logit_filename_m3, force_recompile = TRUE)
```
...
dcat1e[, oid := seq_len(nrow(dcat1e))]
...
# sample
ordcat_logit_endl_fit_m3 <- ordcat_logit_compiled_m3$sample(
  data = stan_data,
  seed = 123,
  chains = 2,
  parallel_chains = 2,
...
# save output to RDS
ordcat_logit_endl_fit_m3$save_object(file = file.path(dir_out, paste0(file_prefix, "m3_stan.rds")))
```
...
ordcat_logit_endl_fit_m3 <- readRDS(file = file.path(dir_out, paste0(file_prefix, "m3_stan.rds")))
```
...
# 	check convergence and check mixing
# 	get 95% credible intervals
tmp <- ordcat_logit_endl_fit_m3$summary(
  variables = c("beta_group", "cut_point_1", "cut_point_gaps_groups"),
  posterior::default_summary_measures(),
  posterior::default_convergence_measures(),
  extra_quantiles = ~ posterior::quantile2(., probs = c(.0275, .975))
...
# extract samples
po <- ordcat_logit_endl_fit_m3$draws(
  variables = c("lp__", worst_var),
  inc_warmup = TRUE,
  format = "draws_array"
)
...
p <- p + theme_bw()
ggsave(
  file = file.path(dir_out, paste0(file_prefix, "m3_worsttrace.png")),
  plot = p,
  h = 10,
  w = 8
)
...
p <- bayesplot::mcmc_intervals(po, prob = 0.5, prob_outer = 0.95, outer_size = 1, point_size = 2) +
  theme_bw()
ggsave(
  file = file.path(dir_out, paste0(file_prefix, "m3_intervals.png")),
  plot = p,
  h = 7,
  w = 8,
  limitsize = FALSE
...
ggsave(
  file = file.path(dir_out, paste0(file_prefix, "m3_pairsplot.png")),
  plot = p,
  h = 50,
  w = 50,
  limitsize = FALSE
...
p <- ggplot(pos, aes(x = oid, group = oid)) +
  ...
  theme(axis.text.x = element_text(angle = 45, vjust = 1, hjust = 1))
ggsave(
  file = file.path(dir_out, paste0(file_prefix, "m3_ppcheck.png")),
  p,
  w = 12,
  h = 12
)
...
ggsave(
  file = file.path(dir_out, paste0(file_prefix, "m3_probs_barplot.png")),
  plot = p,
  h = 8,
  w = 8
)
...
knitr::include_graphics(file.path(dir_out, paste0(file_prefix, "m3_probs_barplot.png")))
```
...
# sample
ordcat_logit_endl_fit_m1 <- ordcat_logit_compiled_m1$sample(
  data = stan_data,
  seed = 123,
  chains = 2,
  parallel_chains = 2,
...
# save output to RDS
ordcat_logit_endl_fit_m1$save_object(file = file.path(dir_out, paste0(file_prefix, "m1_stan.rds")))
```
...
ordcat_logit_endl_fit_m1 <- readRDS(file = file.path(dir_out, paste0(file_prefix, "m1_stan.rds")))
```
...
# 	check convergence and check mixing
# 	get 95% credible intervals
tmp <- ordcat_logit_endl_fit_m1$summary(
...
# extract samples
po <- ordcat_logit_endl_fit_m1$draws(
  variables = c("lp__", worst_var),
  inc_warmup = TRUE,
  format = "draws_array"
)
...
p <- p + theme_bw()
ggsave(
  file = file.path(dir_out, paste0(file_prefix, "m1_worsttrace.png")),
  plot = p,
  h = 10,
  w = 8
)
...
p <- bayesplot::mcmc_intervals(po, prob = 0.5, prob_outer = 0.95, outer_size = 1, point_size = 2) +
  theme_bw()
ggsave(
  file = file.path(dir_out, paste0(file_prefix, "m1_intervals.png")),
  plot = p,
  h = 35,
  w = 8,
  limitsize = FALSE
...
ggsave(
  file = file.path(dir_out, paste0(file_prefix, "m1_pairsplot.png")),
  plot = p,
  h = 50,
  w = 50,
  limitsize = FALSE
...
p <- ggplot(pos, aes(x = oid, group = oid)) +
  ...
  theme(axis.text.x = element_text(angle = 45, vjust = 1, hjust = 1))
ggsave(
  file = file.path(dir_out, paste0(file_prefix, "m1_ppcheck.png")),
  p,
  w = 12,
  h = 12
)
...
ggsave(
  file = file.path(dir_out, paste0(file_prefix, "m1_participant_effects.png")),
  plot = p,
  h = 8,
  w = 12
)
...
knitr::include_graphics(file.path(dir_out, paste0(file_prefix, "m1_participant_effects.png")))
```
...
ggsave(
  file = file.path(dir_out, paste0(file_prefix, "m1_probs_barplot.png")),
  plot = p,
  h = 8,
  w = 8
)
...
knitr::include_graphics(file.path(dir_out, paste0(file_prefix, "m1_probs_barplot.png")))
```
...
# sample
ordcat_logit_fit <- ordcat_logit_compiled_m1$sample(
  data = stan_data,
  seed = 123,
  chains = 2,
  parallel_chains = 2,
...
file_prefix <- "parentalmh_poisson_aggregated_"
...
# save output to RDS
poisson_log_fit_m0$save_object(file = file.path(dir_out, paste0(file_prefix, "m0_stan.rds")))
```
...
pos <-
  po[,
    list(
      summary_value = quantile(pdf, prob = c(0.025, 0.25, 0.5, 0.75, 0.975)),
      summary_name = c("q_lower", "iqr_lower", "median", "iqr_upper", "q_upper")
    ),
    by = c("group", "value")
  ]
...
ggsave(
  file = file.path(dir_out, paste0(file_prefix, "m0_frequencies.png")),
  plot = p,
  h = 10,
  w = 8
)
...
knitr::include_graphics(file.path(dir_out, paste0(file_prefix, "m0_frequencies.png")))
```
...
file_prefix <- "parentalmh_poisson_likert_"
...
# sample
poi_fit_m0 <- poisson_log_compiled_m0$sample(
  data = stan_data,
  seed = 123,
  chains = 2,
  parallel_chains = 2,
...
# sample
poi_fit_m1 <- poisson_log_compiled_m1$sample(
  data = stan_data,
  seed = 123,
  chains = 2,
  parallel_chains = 2,
...
p <- ggplot(pos, aes(x = value)) +
  ...
  labs(x = "Likert outcomes as counts", fill = "", colour = "", y = "proportion of coutcomes")
ggsave(
  file = file.path(dir_out, paste0(file_prefix, "m1_frequencies.png")),
  plot = p,
  h = 10,
  w = 8
)
...
knitr::include_graphics(file.path(dir_out, paste0(file_prefix, "m1_frequencies.png")))
```
...
poi_fit_m0 <- readRDS(file = file.path(dir_out, "parentalmh_poisson_likert_m0_stan.rds"))
poi_fit_m1 <- readRDS(file = file.path(dir_out, "parentalmh_poisson_likert_m1_stan.rds"))
ordcat_logit_fit_m0a <- readRDS(file = file.path(dir_out, "parentalmh_ordcat_m0a_stan.rds"))
ordcat_logit_fit_m0 <- readRDS(file = file.path(dir_out, "parentalmh_ordcat_m0_stan.rds"))
ordcat_logit_fit <- readRDS(file = file.path(dir_out, "parentalmh_ordcat_m1_stan.rds"))

poi_fit_m0_loo <- poi_fit_m0$loo()
poi_fit_m1_loo <- poi_fit_m1$loo()
ordcat_logit_fit_m0a_loo <- ordcat_logit_fit_m0a$loo()
ordcat_logit_fit_m0_loo <- ordcat_logit_fit_m0$loo()
ordcat_logit_fit_loo <- ordcat_logit_fit$loo()
```
...
Fitting this model in a Bayesian setting is however challenging due to the unidentifiability introduced between the $\beta_{g}$ and $\gamma_j$. I tried this, but opted against pursuing this approach further, as it won't scale and well and remains partly unidentifiable.
...
# compile the model
ordcat_logit_filename_m4 <- cmdstanr::write_stan_file(
  gsub("\t", " ", ordcat_logit_txt_m4),
  dir = dir_out,
  basename = NULL,
  force_overwrite = FALSE,
  hash_salt = ""
...
# compile Stan model
ordcat_logit_compiled_m4 <- cmdstanr::cmdstan_model(ordcat_logit_filename_m4, force_recompile = TRUE)
```
...
# sample
ordcat_logit_fit_m4 <- ordcat_logit_compiled_m4$sample(
  data = stan_data,
  seed = 123,
  chains = 2,
  parallel_chains = 2,
...
# save output to RDS
ordcat_logit_fit_m4$save_object(file = file.path(dir_out, paste0(file_prefix, "m4_stan.rds")))
```
```{r ordered_logistic_single_mvn_load_model, include=FALSE, eval=TRUE, echo=FALSE, tidy=FALSE, cache=TRUE}
ordcat_logit_fit_m4 <- readRDS(file = file.path(dir_out, paste0(file_prefix, "m4_stan.rds")))
```
...
# 	check convergence and check mixing
# 	get 95% credible intervals
tmp <- ordcat_logit_fit_m4$summary(
...
p <- p + theme_bw()
ggsave(
  file = file.path(dir_out, paste0(file_prefix, "m4_worsttrace.png")),
  plot = p,
  h = 10,
  w = 8
)
...
p <- bayesplot::mcmc_intervals(po, prob = 0.5, prob_outer = 0.95, outer_size = 1, point_size = 2) +
  theme_bw()
ggsave(
  file = file.path(dir_out, paste0(file_prefix, "m4_intervals.png")),
  plot = p,
  h = 7,
  w = 8,
  limitsize = FALSE
...
po <- ordcat_logit_fit_m4$draws(
  variables = c(
    "lp__", "ordered_prob[1,1]", "ordered_prob[2,1]", "ordered_prob[3,1]", "ordered_prob[4,1]",
...
ggsave(
  file = file.path(dir_out, paste0(file_prefix, "m4_pairsplot.png")),
  plot = p,
  h = 50,
  w = 50,
  limitsize = FALSE
...
po <- ordcat_logit_fit_m4$draws(
  variables = c(
    "lp__", "questions_mvn", "questions_z", "questions_omega[2,1]", "questions_omega[3,1]", "questions_omega[4,1]",
...
ggsave(
  file = file.path(dir_out, paste0(file_prefix, "m4_pairsplot_questions.png")),
  plot = p,
  h = 50,
  w = 50,
  limitsize = FALSE
...
p <- ggplot(pos, aes(x = oid, group = oid)) +
  ...
  theme(axis.text.x = element_text(angle = 45, vjust = 1, hjust = 1))
ggsave(
  file = file.path(dir_out, paste0(file_prefix, "m4_ppcheck.png")),
  p,
  w = 12,
  h = 12
)
...
ggsave(
  file = file.path(dir_out, paste0(file_prefix, "m4_probs_barplot.png")),
  plot = p,
  h = 8,
  w = 8
)
...
knitr::include_graphics(file.path(dir_out, paste0(file_prefix, "m4_probs_barplot.png")))
```
...
p <- ggplot(tmp, aes(x = value_label)) +
  ...
  labs(x = "", x = "Likert scale", y = "proportion of outcomes", fill = "")
ggsave(
  file = file.path(dir_out, paste0(file_prefix, "m4_frequencies_v2.png")),
  plot = p,
  h = 10,
  w = 8
)
...
knitr::include_graphics(file.path(dir_out, paste0(file_prefix, "m4_frequencies_v2.png")))
```
...
# compile the model
ordcat_logit_filename_m4a <- cmdstanr::write_stan_file(
  gsub("\t", " ", ordcat_logit_txt_m4a),
  dir = dir_out,
  basename = NULL,
  force_overwrite = FALSE,
  hash_salt = ""
...
# compile Stan model
ordcat_logit_compiled_m4a <- cmdstanr::cmdstan_model(ordcat_logit_filename_m4a, force_recompile = TRUE)
```
...
stan_data$question_of_obs <- dcat1$vid
# sample
ordcat_logit_fit_m4a <- ordcat_logit_compiled_m4a$sample(
  data = stan_data,
  seed = 123,
  chains = 2,
  parallel_chains = 2,
...
# save output to RDS
ordcat_logit_fit_m4a$save_object(file = file.path(dir_out, paste0(file_prefix, "m4a_stan.rds")))
```
```{r ordered_logistic_a_s2z_load_model, include=FALSE, eval=TRUE, echo=FALSE, tidy=FALSE, cache=TRUE}
ordcat_logit_fit_m4a <- readRDS(file = file.path(dir_out, paste0(file_prefix, "m4a_stan.rds")))
```
...
# 	check convergence and check mixing
# 	get 95% credible intervals
tmp <- ordcat_logit_fit_m4a$summary(
...
p <- p + theme_bw()
ggsave(
  file = file.path(dir_out, paste0(file_prefix, "m4a_worsttrace.png")),
  plot = p,
  h = 10,
  w = 8
)
...
p <- bayesplot::mcmc_intervals(po, prob = 0.5, prob_outer = 0.95, outer_size = 1, point_size = 2) +
  theme_bw()
ggsave(
  file = file.path(dir_out, paste0(file_prefix, "m4a_intervals.png")),
  plot = p,
  h = 7,
  w = 8,
  limitsize = FALSE
...
ggsave(
  file = file.path(dir_out, paste0(file_prefix, "m4a_pairsplot.png")),
  plot = p,
  h = 50,
  w = 50,
  limitsize = FALSE
...
ggsave(
  file = file.path(dir_out, paste0(file_prefix, "m4a_pairsplot_questions.png")),
  plot = p,
  h = 20,
  w = 20,
  limitsize = FALSE
...
p <- ggplot(pos, aes(x = oid, group = oid)) +
  ...
  theme(axis.text.x = element_text(angle = 45, vjust = 1, hjust = 1))
ggsave(
  file = file.path(dir_out, paste0(file_prefix, "m4a_ppcheck.png")),
  p,
  w = 12,
  h = 12
)
...
p <- p + scale_fill_npg() +
  theme_bw()
ggsave(
  file = file.path(dir_out, paste0(file_prefix, "m4a_eta_pairsplot.png")),
  plot = p,
  h = 10,
  w = 10
)
...
knitr::include_graphics(file.path(dir_out, paste0(file_prefix, "m4a_eta_pairsplot.png")))
```
...
ggsave(
  file = file.path(dir_out, paste0(file_prefix, "m4a_probs_barplot.png")),
  plot = p,
  h = 8,
  w = 8
)
...
knitr::include_graphics(file.path(dir_out, paste0(file_prefix, "m4a_probs_barplot.png")))
```
...
p <- ggplot(tmp, aes(x = value_label)) +
  ...
  labs(x = "", x = "Likert scale", y = "proportion of outcomes", fill = "")
ggsave(
  file = file.path(dir_out, paste0(file_prefix, "m4a_frequencies_v2.png")),
  plot = p,
  h = 10,
  w = 8
)
...
knitr::include_graphics(file.path(dir_out, paste0(file_prefix, "m4a_frequencies_v2.png")))
```
...
p <- p + scale_fill_npg() +
  theme_bw()
ggsave(
  file = file.path(dir_out, paste0(file_prefix, "m4_eta_pairsplot.png")),
  plot = p,
  h = 10,
  w = 10
)
...
knitr::include_graphics(file.path(dir_out, paste0(file_prefix, "m4_eta_pairsplot.png")))
```
...
ordcat_logit_fit_m0a <- readRDS(file = file.path(dir_out, "parentalmh_ordcat_m0a_stan.rds"))
ordcat_logit_fit <- readRDS(file = file.path(dir_out, "parentalmh_ordcat_m1_stan.rds"))
ordcat_logit_fit_m4a <- readRDS(file = file.path(dir_out, "parentalmh_ordcat_m4a_stan.rds"))
ordcat_logit_fit_m4 <- readRDS(file = file.path(dir_out, "parentalmh_ordcat_m4_stan.rds"))
...
ordcat_logit_fit_m0a_loo <- ordcat_logit_fit_m0a$loo()
ordcat_logit_fit_loo <- ordcat_logit_fit$loo()
ordcat_logit_fit_m4a_loo <- ordcat_logit_fit_m4a$loo()
ordcat_logit_fit_m4_loo <- ordcat_logit_fit_m4$loo()
```
...
comp <- loo::loo_compare(
  ...
  ordcat_logit_fit_m0_loo,
  ordcat_logit_fit_loo,
  ordcat_logit_fit_m4a_loo,
  ordcat_logit_fit_m4_loo
)
print(comp, simplify = FALSE)
```
...
# compile the model
ordcat_logit_m5a_filename <- cmdstanr::write_stan_file(
  gsub("\t", " ", ordcat_logit_txt_m5a),
  dir = dir_out,
  basename = NULL,
  force_overwrite = FALSE,
  hash_salt = ""
...
# compile Stan model
ordcat_logit_compiled_m5a <- cmdstanr::cmdstan_model(ordcat_logit_m5a_filename)
```
...
# sample
ordcat_logit_fit_m5a <- ordcat_logit_compiled_m5a$sample(
  data = stan_data,
  seed = 123,
  chains = 2,
  parallel_chains = 2,
...
# save output to RDS
ordcat_logit_fit_m5a$save_object(file = file.path(dir_out, paste0(file_prefix, "m5a_stan.rds")))
```

```{r ordered_logistic_latent_factor-a_load_model, include=FALSE, eval=TRUE, echo=FALSE, tidy=FALSE, cache=TRUE}
ordcat_logit_fit_m5 <- readRDS(file = file.path(dir_out, paste0(file_prefix, "m5a_stan.rds")))
```

```{r ordered_logistic_latent_factor-a_check_mixing_convergence, include=FALSE, eval=TRUE, echo=FALSE, tidy=FALSE, cache=TRUE}
# 	check convergence and check mixing
# 	get 95% credible intervals
tmp <- ordcat_logit_fit_m5a$summary(
  variables = c(
    "factor_group", "beta_unit", "beta_unit_sd", "beta_questions",
...
p <- p + theme_bw()
ggsave(
  file = file.path(dir_out, paste0(file_prefix, "m5a_worsttrace.png")),
  plot = p,
  h = 10,
  w = 8
)
...
po <- ordcat_logit_fit_m5a$draws(
  variables = c(
    "factor_group", "beta_questions", "loadings_questions",
...
p <- bayesplot::mcmc_intervals(po, prob = 0.5, prob_outer = 0.95, outer_size = 1, point_size = 2) +
  theme_bw()
ggsave(
  file = file.path(dir_out, paste0(file_prefix, "m5a_intervals.png")),
  plot = p,
  h = 40,
  w = 8,
  limitsize = FALSE
...
ggsave(
  file = file.path(dir_out, paste0(file_prefix, "m5a_pairsplot.png")),
  plot = p,
  h = 30,
  w = 30,
  limitsize = FALSE
...
p <- ggplot(pos, aes(x = oid, group = oid)) +
  ...
  theme(axis.text.x = element_text(angle = 45, vjust = 1, hjust = 1))
ggsave(
  file = file.path(dir_out, paste0(file_prefix, "m5a_ppcheck.png")),
  p,
  w = 12,
  h = 12
)
...
ggsave(
  file = file.path(dir_out, paste0(file_prefix, "m5a_participant_effects.png")),
  plot = p,
  h = 8,
  w = 12
)
...
knitr::include_graphics(file.path(dir_out, paste0(file_prefix, "m5a_participant_effects.png")))
```
...
p <- p + scale_fill_npg() +
  theme_bw()
ggsave(
  file = file.path(dir_out, paste0(file_prefix, "m5a_eta_pairsplot.png")),
  plot = p,
  h = 10,
  w = 10
)
...
knitr::include_graphics(file.path(dir_out, paste0(file_prefix, "m5a_eta_pairsplot.png")))
```
...
ggsave(
  file = file.path(dir_out, paste0(file_prefix, "m5a_probs_barplot.png")),
  plot = p,
  h = 8,
  w = 8
)
...
knitr::include_graphics(file.path(dir_out, paste0(file_prefix, "m5a_probs_barplot.png")))
```
...
p <- ggplot(pos, aes(x = value_label, group = interaction(variable, value_label))) +
  ...
  labs(x = "", x = "Likert scale", y = "proportion of outcomes", fill = "")
ggsave(
  file = file.path(dir_out, paste0(file_prefix, "m5a_frequencies_v2.png")),
  plot = p,
  h = 10,
  w = 8
)
...
knitr::include_graphics(file.path(dir_out, paste0(file_prefix, "m5a_frequencies_v2.png")))
```
...
# compile the model
ordcat_logit_m5_filename <- cmdstanr::write_stan_file(
  gsub("\t", " ", ordcat_logit_txt_m5),
  dir = dir_out,
  basename = NULL,
  force_overwrite = FALSE,
  hash_salt = ""
...
# compile Stan model
ordcat_logit_compiled_m5 <- cmdstanr::cmdstan_model(ordcat_logit_m5_filename)
```
...
# sample
ordcat_logit_fit_m5 <- ordcat_logit_compiled_m5$sample(
  data = stan_data,
  seed = 123,
  chains = 2,
  parallel_chains = 2,
...
p <- p + theme_bw()
ggsave(
  file = file.path(dir_out, paste0(file_prefix, "m5_worsttrace.png")),
  plot = p,
  h = 10,
  w = 8
)
...
p <- bayesplot::mcmc_intervals(po, prob = 0.5, prob_outer = 0.95, outer_size = 1, point_size = 2) +
  theme_bw()
ggsave(
  file = file.path(dir_out, paste0(file_prefix, "m5_intervals.png")),
  plot = p,
  h = 40,
  w = 8,
  limitsize = FALSE
...
ggsave(
  file = file.path(dir_out, paste0(file_prefix, "m5_pairsplot.png")),
  plot = p,
  h = 30,
  w = 30,
  limitsize = FALSE
...
p <- ggplot(pos, aes(x = oid, group = oid)) +
  ...
  theme(axis.text.x = element_text(angle = 45, vjust = 1, hjust = 1))
ggsave(
  file = file.path(dir_out, paste0(file_prefix, "m5_ppcheck.png")),
  p,
  w = 12,
  h = 12
)
...
ggsave(
  file = file.path(dir_out, paste0(file_prefix, "m5_participant_effects.png")),
  plot = p,
  h = 8,
  w = 12
)
...
knitr::include_graphics(file.path(dir_out, paste0(file_prefix, "m5_participant_effects.png")))
```
...
p <- p + scale_fill_npg() +
  theme_bw()
ggsave(
  file = file.path(dir_out, paste0(file_prefix, "m5_eta_pairsplot.png")),
  plot = p,
  h = 10,
  w = 10
)
...
knitr::include_graphics(file.path(dir_out, paste0(file_prefix, "m5_eta_pairsplot.png")))
```
...
ggsave(
  file = file.path(dir_out, paste0(file_prefix, "m5_probs_barplot.png")),
  plot = p,
  h = 8,
  w = 8
)
...
Here is the model fit (in black) relative to the aggregated survey items. Hooray, we retain a good fit relative to our primary target statistics:

```{r ordered_logistic_latent_factor_plot, include=TRUE, eval=TRUE, echo=FALSE, tidy=FALSE, fig.align='center', out.width='80%'}
knitr::include_graphics(file.path(dir_out, paste0(file_prefix, "m5_probs_barplot.png")))
```
...
p <- ggplot(pos, aes(x = value_label, group = interaction(variable, value_label))) +
  ...
  labs(x = "", x = "Likert scale", y = "proportion of outcomes", fill = "")
ggsave(
  file = file.path(dir_out, paste0(file_prefix, "m5_frequencies_v2.png")),
  plot = p,
  h = 10,
  w = 8
)
...
knitr::include_graphics(file.path(dir_out, paste0(file_prefix, "m5_frequencies_v2.png")))
```
...
p <- ggplot(pos, aes(x = PHQ4_down, group = interaction(PHQ4_down, value_label))) +
  ...
  facet_grid(arm_label ~ time_label)
ggsave(
  file = file.path(dir_out, paste0(file_prefix, "m5_polychoric_correlations_across_PHQ_questions_same_arm-time.png")),
  plot = p,
  h = 8,
  w = 8
)
...
knitr::include_graphics(file.path(dir_out, paste0(file_prefix, "m5_polychoric_correlations_across_PHQ_questions_same_arm-time.png")))
```
...
group-specific loadings. I intentionally do not introduce group-specific participant effects, because the
...
# compile the model
ordcat_logit_m5b_filename <- cmdstanr::write_stan_file(
  gsub("\t", " ", ordcat_logit_txt_m5b),
  dir = dir_out,
  basename = NULL,
  force_overwrite = FALSE,
  hash_salt = ""
...
# compile Stan model
ordcat_logit_compiled_m5b <- cmdstanr::cmdstan_model(ordcat_logit_m5b_filename)
```
Let's fit the model!
...
# sample
ordcat_logit_fit_m5b <- ordcat_logit_compiled_m5b$sample(
  data = stan_data,
  seed = 123,
  chains = 2,
  parallel_chains = 2,
...
p <- p + theme_bw()
ggsave(
  file = file.path(dir_out, paste0(file_prefix, "m5b_worsttrace.png")),
  plot = p,
  h = 10,
  w = 8
)
...
p <- bayesplot::mcmc_intervals(po, prob = 0.5, prob_outer = 0.95, outer_size = 1, point_size = 2) +
  theme_bw()
ggsave(
  file = file.path(dir_out, paste0(file_prefix, "m5b_intervals.png")),
  plot = p,
  h = 50,
  w = 8,
  limitsize = FALSE
...
ggsave(
  file = file.path(dir_out, paste0(file_prefix, "m5b_pairsplot.png")),
  plot = p,
  h = 30,
  w = 30,
  limitsize = FALSE
...
p <- ggplot(pos, aes(x = oid, group = oid)) +
  ...
  theme(axis.text.x = element_text(angle = 45, vjust = 1, hjust = 1))
ggsave(
  file = file.path(dir_out, paste0(file_prefix, "m5b_ppcheck.png")),
  p,
  w = 12,
  h = 12
)
...
ggsave(
  file = file.path(dir_out, paste0(file_prefix, "m5b_participant_effects.png")),
  plot = p,
  h = 8,
  w = 12
)
...
knitr::include_graphics(file.path(dir_out, paste0(file_prefix, "m5b_participant_effects.png")))
```
...
p <- p + scale_fill_npg() +
  theme_bw()
ggsave(
  file = file.path(dir_out, paste0(file_prefix, "m5b_eta_pairsplot.png")),
  plot = p,
  h = 10,
  w = 10
)
...
knitr::include_graphics(file.path(dir_out, paste0(file_prefix, "m5b_eta_pairsplot.png")))
```
...
ggsave(
  file = file.path(dir_out, paste0(file_prefix, "m5b_probs_barplot.png")),
  plot = p,
  h = 8,
  w = 8
)
...
knitr::include_graphics(file.path(dir_out, paste0(file_prefix, "m5b_probs_barplot.png")))
```
...
p <- ggplot(pos, aes(x = value_label, group = interaction(variable, value_label))) +
  ...
  labs(x = "", x = "Likert scale", y = "proportion of outcomes", fill = "")
ggsave(
  file = file.path(dir_out, paste0(file_prefix, "m5b_frequencies_v2.png")),
  plot = p,
  h = 10,
  w = 8
)
...
knitr::include_graphics(file.path(dir_out, paste0(file_prefix, "m5b_frequencies_v2.png")))
```
...
ordcat_logit_fit_m4a <- readRDS(file = file.path(dir_out, "parentalmh_ordcat_m4a_stan.rds"))
ordcat_logit_fit_m4 <- readRDS(file = file.path(dir_out, "parentalmh_ordcat_m4_stan.rds"))
ordcat_logit_fit_m5a <- readRDS(file = file.path(dir_out, "parentalmh_ordcat_m5a_stan.rds"))
ordcat_logit_fit_m5 <- readRDS(file = file.path(dir_out, "parentalmh_ordcat_m5_stan.rds"))
ordcat_logit_fit_m5b <- readRDS(file = file.path(dir_out, "parentalmh_ordcat_m5b_stan.rds"))
...
ordcat_logit_fit_m4a_loo <- ordcat_logit_fit_m4a$loo()
ordcat_logit_fit_m4_loo <- ordcat_logit_fit_m4$loo()
ordcat_logit_fit_m5a_loo <- ordcat_logit_fit_m5a$loo()
ordcat_logit_fit_m5_loo <- ordcat_logit_fit_m5$loo()
ordcat_logit_fit_m5b_loo <- ordcat_logit_fit_m5b$loo()
```
...
comp <- loo::loo_compare(
  ...
  ordcat_logit_fit_m4a_loo,
  ordcat_logit_fit_m4_loo,
  ordcat_logit_fit_m5a_loo,
  ordcat_logit_fit_m5_loo,
  ordcat_logit_fit_m5b_loo
)
print(comp, simplify = FALSE)
```
...
Let us move to the VAC data, and repeat the main steps above. Here are the survey responses to each of the 10 items targeting latent behaviour 'violence against children (VAC)' across participants:
...
Polychoric correlations among item responses in the same group are again very high:
...
# sample
vac_ordcat_logit_fit_m0 <- ordcat_logit_compiled_m0$sample(
  data = stan_data,
  seed = 123,
  chains = 2,
  parallel_chains = 2,
...
# extract samples
po <- vac_ordcat_logit_fit_m0$draws(
  variables = c("lp__", worst_var),
  inc_warmup = TRUE,
  format = "draws_array"
)
...
# sample
vac_ordcat_logit_fit <- ordcat_logit_compiled_m1$sample(
  data = stan_data,
  seed = 123,
  chains = 2,
  parallel_chains = 2,
...
# save output to RDS
vac_ordcat_logit_fit$save_object(file = file.path(dir_out, paste0(file_prefix, "m1_stan.rds")))
```


```{r vac_ordered_logistic_with_unit_effects_load_model, include=FALSE, eval=TRUE, echo=FALSE, tidy=FALSE, cache=TRUE}
vac_ordcat_logit_fit <- readRDS(file = file.path(dir_out, paste0(file_prefix, "m1_stan.rds")))
```
...
# 	check convergence and check mixing
# 	get 95% credible intervals
tmp <- vac_ordcat_logit_fit$summary(
  variables = c("beta_group", "beta_unit", "beta_unit_sd", "cut_point_1", "cut_point_gaps_groups"),
  posterior::default_summary_measures(),
  posterior::default_convergence_measures(),
  extra_quantiles = ~ posterior::quantile2(., probs = c(.0275, .975))
...
p <- ggplot(pos, aes(x = VACE_threat, group = interaction(VACE_threat, value_label))) +
  ...
  facet_grid(arm_label ~ time_label)
ggsave(
  file = file.path(dir_out, paste0(file_prefix, "m1_polychoric_correlations_across_vac_questions_same_arm-time.png")),
  plot = p,
  h = 8,
  w = 8
)
...
knitr::include_graphics(file.path(dir_out, paste0(file_prefix, "m1_polychoric_correlations_across_vac_questions_same_arm-time.png")))
```
...
file_prefix <- "vac_poisson_aggregated_"
...
# save output to RDS
vac_poisson_log_fit_m0$save_object(file = file.path(dir_out, paste0(file_prefix, "m0_stan.rds")))
```
...
file_prefix <- "vac_poisson_likert_"
...
# sample
vac_poi_fit_m0 <- poisson_log_compiled_m0$sample(
  data = stan_data,
  seed = 123,
  chains = 2,
  parallel_chains = 2,
...
# save output to RDS
vac_poi_fit_m0$save_object(file = file.path(dir_out, paste0(file_prefix, "m0_stan.rds")))
```
...
# sample
vac_poi_fit_m1 <- poisson_log_compiled_m1$sample(
  data = stan_data,
  seed = 123,
  chains = 2,
  parallel_chains = 2,
...
# sample
vac_ordcat_logit_fit_m5 <- ordcat_logit_compiled_m5$sample(
  data = stan_data,
  seed = 123,
  chains = 2,
  parallel_chains = 2,
...
# extract samples
po <- vac_ordcat_logit_fit_m5$draws(
  variables = c("lp__", worst_var),
  inc_warmup = TRUE,
  format = "draws_array"
)
...
p <- GGally::ggpairs(po,
  columns = c(
    "VACE_threat", "VACE_refusespeak", "VACE_insult",
...
Here is the model fit (in black) relative to the aggregated survey items. Hooray, we have a good fit relative to our primary target statistics:
...
vac_ordcat_logit_fit_m0 <- readRDS(file = file.path(dir_out, "vac_ordcat_m0_stan.rds"))
vac_ordcat_logit_fit <- readRDS(file = file.path(dir_out, "vac_ordcat_m1_stan.rds"))
vac_ordcat_logit_fit_m5 <- readRDS(file = file.path(dir_out, "vac_ordcat_m5_stan.rds"))
vac_poi_fit_m0 <- readRDS(file = file.path(dir_out, "vac_poisson_likert_m0_stan.rds"))
vac_poi_fit_m1 <- readRDS(file = file.path(dir_out, "vac_poisson_likert_m1_stan.rds"))

vac_poi_fit_m0_loo <- vac_poi_fit_m0$loo()
vac_poi_fit_m1_loo <- vac_poi_fit_m1$loo()
vac_ordcat_logit_fit_m0_loo <- vac_ordcat_logit_fit_m0$loo()
vac_ordcat_logit_fit_loo <- vac_ordcat_logit_fit$loo()
vac_ordcat_logit_fit_m5_loo <- vac_ordcat_logit_fit_m5$loo()
```
...
comp <- loo::loo_compare(
  vac_poi_fit_m0_loo,
  vac_poi_fit_m1_loo,
  vac_ordcat_logit_fit_m0_loo,
  vac_ordcat_logit_fit_loo,
  vac_ordcat_logit_fit_m5_loo
)
...
The primary endpoint in this pre-post study is comparing the average change $\Delta_{g,f}$ in negative outcomes in the latent behavioural factors $f$ (parental mental health, violence against children) that occur 'Nearly every day' between Baseline and Endline among the Intervention and Control groups $g \in \{I, C\}$, respectively. We will quantify the corresponding risk differences,
\begin{equation}
...
pos[, variable_label := factor(variable,
  levels = c("diff", "ratio"),
...
ggsave(
  file = file.path(dir_out, paste0("final_riskdifference_in_group.png")),
  plot = p,
  h = 8,
  w = 8
)
...
ggsave(
  file = file.path(dir_out, paste0("final_percentchange_in_group.png")),
  plot = p,
  h = 8,
  w = 8
)
...
ggsave(
  file = file.path(dir_out, paste0("final_percentchange_and_riskdifference_in_group.png")),
  plot = p,
  h = 8,
  w = 8
)
...
knitr::include_graphics(file.path(dir_out, paste0("final_percentchange_and_riskdifference_in_group.png")))
```
